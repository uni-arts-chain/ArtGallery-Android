package com.artgallery.eth.util;
...
public class ETHWalletUtils {
    ...
    public static String ETH_CUSTOM_TYPE2 = "m/44'/1596421679'/0'/0/0";
     ...
     * @return
     */
    public static ETHWallet generateMnemonic(String walletName, String pwd, String symble) {
        String type;
        if (!TextUtils.isEmpty(symble)) {
            type = symble.equalsIgnoreCase("qts") ? ETH_CUSTOM_TYPE2 : ETH_JAXX_TYPE;
        } else type = ETH_JAXX_TYPE;
        String[] pathArray = type.split("/");
        String passphrase = "";
...
//            ToastUtils.showToast(R.string.load_wallet_by_official_wallet_keystore_input_tip);
    ...
    public static boolean isTooSimplePrivateKey(String privateKey) {
        int value = Numeric.toBigInt(privateKey).intValue();
//        if (value < 100000000) {
//            return true;
//        } else {
//            return false;
//        }
        return !Numeric.containsHexPrefix(privateKey);
    }
