package com.artgallery.eth.base;
...
//    public static final String TICKER_API_URL = "https://qtswallet.cn";
    public static final String TICKER_API_URL = "https://thhcmall.top/";
//    public static final String TICKER_API_URL_OTC = "https://otc.qtswallet.cn";
    public static final String TICKER_API_URL_OTC = "https://otc.thhcmall.top/";
    ...
    public static final String QTS_MAIN_NETWORK_NAME = "Mainnet_qts";
    ...
    public static final String QTS_NAME = "Quaternions";
    public static final String ETH_NAME = "Ethereum";
    public static final String DOT_NAME = "";
    public static final String DOT_SYMBOL = "DOT";
    ...
    public static final String QTS_SYMBOL = "QTS";
    public static final String TMS_SYMBOL = "TMS";
    ...
    public static final String EXTRA_WALLET_SYMBOL = "W_SYMBOL";
    ...
    public static final String EXTRA_TOTAL_PRICE = "total";
