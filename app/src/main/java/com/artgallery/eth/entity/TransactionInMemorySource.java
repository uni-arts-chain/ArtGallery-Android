package com.artgallery.eth.entity;

import android.text.format.DateUtils;

import com.artgallery.eth.repository.TransactionLocalSource;
...
public class TransactionInMemorySource implements TransactionLocalSource {
    ...
    @Override
    public Single<Transaction[]> fetchTransaction(String walletAddr,String coin) {
