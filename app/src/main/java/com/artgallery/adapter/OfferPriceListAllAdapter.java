...
public class OfferPriceListAllAdapter extends BaseQuickAdapter<OfferPriceBean, BaseViewHolder> {

    private List<OfferPriceBean> mData;

    private Context mContext;

    public OfferPriceListAllAdapter(Context context, List<OfferPriceBean> data) {
