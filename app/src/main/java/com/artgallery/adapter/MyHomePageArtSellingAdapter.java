...
public class MyHomePageArtSellingAdapter extends BaseQuickAdapter<SellingArtVo, BaseViewHolder> {

    public MyHomePageArtSellingAdapter(List<SellingArtVo> data) {
        super(R.layout.my_homepage_art_item_selling, data);
    }
