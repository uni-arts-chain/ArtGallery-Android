...
//    }
    ...
    public static int dip2px(float dipValue) {
        float scale = YunApplication.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        float fontScale =YunApplication.getInstance().getResources().getDisplayMetrics().scaledDensity;
